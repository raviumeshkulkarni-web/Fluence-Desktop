// Provider brand/glyph icons, copied verbatim from the vanilla
// #page-providers markup (src/index.html). Fixed sizes as in vanilla.
...
export function RefreshIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true"><polyline points="1 4 1 10 7 10" /><path d="M3.51 15a9 9 0 1 0 .49-4.9" /></svg>
  );
}
